...
from .base import BaseRecognizer,BaseRecognizer_ours,BaseRecognizer_ours_manet_backbone
...
@RECOGNIZERS.register_module()
class Recognizer2D_ours_trying_manet_backbone(BaseRecognizer_ours_manet_backbone):
    """2D recognizer model framework."""
