...
pickle_file_path = 'online_evaluation/unique_experts_with_videomae_cross_attn_cross_entropy_ma52_final_testing_on_val.pickle'
pred_file_path = 'online_evaluation/predictions_on_val_our_model.csv'
zip_file_path = 'online_evaluation/predictions_on_val_our_model.zip'
