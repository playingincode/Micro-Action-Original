...
python -u tools/test.py configs/recognition/manet/manet.py "" --out online_evaluation/unique_experts_with_videomae_cross_attn_cross_entropy_final_weights_check.pickle