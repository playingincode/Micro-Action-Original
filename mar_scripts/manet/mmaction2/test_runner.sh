...
#OAR --name unique_experts_with_videomae_concatenation_cross_entropy_test
...
python -u tools/test.py configs/recognition/manet/manet.py  /srv/storage/stars@storage3.sophia.grid5000.fr/npoddar/MANET_original_six_classes/Micro-Action/mar_scripts/manet/mmaction2/work_dirs/unique_experts_with_videomae_concatenation_cross_entropy_final/best_top1_acc_epoch_257.pth --out online_evaluation/unique_experts_with_videomae_concatenation_cross_entropy_ma52_final_cvpr.pickle