...
python -u tools/test.py configs/recognition/manet/manet.py  /srv/storage/stars@storage3.sophia.grid5000.fr/npoddar/MANET_original_six_classes/Micro-Action/mar_scripts/manet/mmaction2/work_dirs/unique_experts_with_videomae_question_cross_attn_cross_entropy_Social_Gesture_final/best_top1_acc_epoch_307.pth --out online_evaluation/unique_experts_with_videomae_cross_attention_checking_results_Social_gesture.pickle