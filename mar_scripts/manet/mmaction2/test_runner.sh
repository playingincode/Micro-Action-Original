...
python -u tools/test.py configs/recognition/manet/manet.py  /srv/storage/stars@storage3.sophia.grid5000.fr/npoddar/MANET_original_six_classes/Micro-Action/mar_scripts/manet/mmaction2/work_dirs/unique_experts_with_videomae_cross_attn_cross_entropy_final_without_manet/best_top1_acc_epoch_55.pth --out online_evaluation/unique_experts_with_videomae_cross_attn_cross_entropy_without_manet_ma52_final.pickle