...
model = dict(
    ...
    body_head_model=dict(
        type='Recognizer2D_ours',
        pretrained='/srv/storage/stars@storage3.sophia.grid5000.fr/npoddar/Micro-Action/mar_scripts/manet/mmaction2/work_dirs/manet_prova_sgp_head_body_passive/best_top1_acc_epoch_31.pth',
        backbone=dict(
            type='ResNetTSM',
            pretrained='torchvision://resnet50',
            depth=50,
    ...
    upper_limb_model=dict(
        type='Recognizer2D_ours',
        pretrained='/srv/storage/stars@storage3.sophia.grid5000.fr/npoddar/Micro-Action/mar_scripts/manet/mmaction2/work_dirs/manet_prova_sgp_upper_limb_passive/best_top1_acc_epoch_39.pth',
        backbone=dict(
            type='ResNetTSM',
            pretrained='torchvision://resnet50',
            depth=50,
    ...
    lower_limb_model=dict(
        type='Recognizer2D_ours',
        pretrained='/srv/storage/stars@storage3.sophia.grid5000.fr/npoddar/Micro-Action/mar_scripts/manet/mmaction2/work_dirs/manet_prova_sgp_lower_limb_passive/best_top1_acc_epoch_57.pth',
        backbone=dict(
            type='ResNetTSM',
            pretrained='torchvision://resnet50',
            depth=50,
